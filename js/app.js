...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Verifica si existe la variable googleLoginUrl y si el botón está presente
    if (typeof googleLoginUrl !== 'undefined' && googleSignInButton) {
        googleSignInButton.addEventListener('click', function() {
            window.location.href = googleLoginUrl; // Redirige al usuario para la autenticación de Google
        });
    }
